    ...
    <main class="form-registration">
        ...
        <form action="/artikel" method="post" enctype="multipart/form-data">
          ...
          <div class="form-floating">
            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" id="judul" placeholder="Judul" required value="{{ old('judul') }}">
          ...
          <div class="form-floating">
            <textarea class="h-40 w-96" name="isi" class="form-control @error('isi') is-invalid @enderror" id="isi" placeholder="Isi" required>{{ old('isi') }}</textarea>
